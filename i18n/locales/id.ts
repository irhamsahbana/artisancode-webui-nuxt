export default {
  ...
  auth: {
    ...
    tenantNameHint: "Nama perusahaan atau cabang yang akan tampil di aplikasi.",
    emailPlaceholder: "anda{'@'}perusahaan.com",
    fullNamePlaceholder: "Nama lengkap Anda",
    usernamePlaceholder: "namauser",
    signIn: "Masuk",
  ...
  ui: {
    ...
    branchIdIsMissing: "ID cabang tidak ditemukan.",
    branches: "Cabang",
    ...
    categories: "Kategori",
    categoryCreatedSuccessfully: "Kategori berhasil dibuat",
    categoryIdIsMissing: "ID kategori tidak ditemukan.",
    ...
    name: "Nama",
    nameAndCityAreRequired: "Nama dan kota wajib diisi.",
