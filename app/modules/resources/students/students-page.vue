...
const createForm = ref<StudentFormValues>({ ...emptyValues })
...
const submitCreate = async () => {
  const values = createForm.value
  const branchIdValue = (values.branch_id ?? '').trim()
  const firstNameValue = (values.first_name ?? '').trim()
  const lastNameValue = (values.last_name ?? '').trim()
  const genderValue = values.gender
  const dateOfBirthValue = values.date_of_birth ?? ''
  if (!branchIdValue || !firstNameValue || !lastNameValue || !genderValue || !dateOfBirthValue) {
    show('Branch, first name, last name, gender, and date of birth are required.', 'error')
    return
  }
  if (!genderOptions.includes(genderValue as (typeof genderOptions)[number])) {
    show('Invalid gender value.', 'error')
    return
  }
  if (Number.isNaN(Date.parse(dateOfBirthValue))) {
    show('Date of birth is invalid.', 'error')
    return
  }
  ...
  const response = await apiFetch<Record<string, unknown>>('/students', {
    method: 'POST',
    body: payload,
  })
  createLoading.value = false
    ...
    <div class="w-full max-w-4xl rounded-lg border bg-card p-6 shadow-lg">
      ...
      <div class="mt-4 grid gap-4">
        <div class="grid gap-4 sm:grid-cols-2">
          <div class="grid gap-2">
            <Label for="create-student-first-name">First name</Label>
            <Input
          ...
          <div class="grid gap-2">
            <Label for="create-student-last-name">Last name</Label>
            <Input
          ...
          <div class="grid gap-2">
            <Label for="create-student-email">Email</Label>
            <Input
          ...
          <div class="grid gap-2">
            <Label for="create-student-branch">Branch</Label>
            <SearchableSelect
              id="create-student-branch"
          ...
          <div class="grid gap-2">
            <Label for="create-student-gender">Gender</Label>
            <SearchableSelect
          ...
          <div class="grid gap-2">
            <Label for="create-student-date-of-birth">Date of birth</Label>
            <Input
              id="create-student-date-of-birth"
          ...
          <div class="grid gap-2">
            <Label for="create-student-birth-place">Birth place</Label>
            <Input
              id="create-student-birth-place"
              v-model="createForm.birth_place"
              :disabled="createLoading"
            />
          </div>
          <div class="grid gap-2">
            <Label for="create-student-status">Status</Label>
            <SearchableSelect
          ...
          <div class="grid gap-2 sm:col-span-2">
            <Label for="create-student-address">Address</Label>
            <Input
              id="create-student-address"
              v-model="createForm.address"
              :disabled="createLoading"
            />
          </div>
          <div class="grid gap-2">
            <Label for="create-student-photo">Photo URL</Label>
            <Input
          ...
          <div class="grid gap-2">
            <Label for="create-student-blood-type">Blood type</Label>
            <SearchableSelect
              id="create-student-blood-type"
              v-model="createForm.blood_type"
              :disabled="createLoading"
              :options="bloodTypeOptionList"
              placeholder="Select blood type"
              search-placeholder="Search blood type"
          ...
          <div class="grid gap-2">
            <Label for="create-student-parent-name">Parent name</Label>
            <Input
          ...
          <div class="grid gap-2">
            <Label for="create-student-parent-phone">Parent phone</Label>
            <Input
              id="create-student-parent-phone"
              v-model="createForm.parent_phone"
              :disabled="createLoading"
            />
          </div>
          <div class="grid gap-2">
            <Label for="create-student-parent-email">Parent email</Label>
            <Input
              id="create-student-parent-email"
              v-model="createForm.parent_email"
              type="email"
              :disabled="createLoading"
            />
          </div>
          <div class="grid gap-2">
            <Label for="create-student-emergency-phone">Emergency phone</Label>
            <Input
              id="create-student-emergency-phone"
              v-model="createForm.emergency_contact_phone"
              :disabled="createLoading"
            />
          </div>
          <div class="grid gap-2 sm:col-span-2">
            <Label for="create-student-medical-notes">Medical notes</Label>
            <textarea
              id="create-student-medical-notes"
